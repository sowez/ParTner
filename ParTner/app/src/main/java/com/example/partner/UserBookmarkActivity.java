...
public class UserBookmarkActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        mainLayout = (ViewGroup) findViewById(R.id.id_user_bookmark_list);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.bookmark_list_recyclerview);
    ...
    public void getBookmark(){
        ...
        retrofitcomm.getBookmark(SharedPreferenceData.getId(this)).enqueue(new Callback<List<TrainerProfile>>() {
            @Override
            ...
            public void onFailure(Call<List<TrainerProfile>> call, Throwable t) {
                Log.e("bookmark", "userBookMarkactivity onFailure: 정보받아오기 실패");
            }
        });
